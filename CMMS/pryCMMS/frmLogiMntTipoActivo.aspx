<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/PM_Cmms.Master" CodeBehind="frmLogiMntTipoActivo.aspx.vb" Inherits="pryCMMS.frmLogiMntTipoActivo" %>
        ...
        <div class="panel panel-default">
            <div id="dvTab">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item"><a class="nav-link active" href="#tab1" aria-controls="tab1" role="tab" data-toggle="tab">Listado de Tipo de Activo</a></li>
                        ...
                        <asp:UpdatePanel ID="updpnlTab1" runat="server">
                            <ContentTemplate>
                                ...
                                <asp:Panel ID="pnlListado" runat="server" CssClass="container" 
                                    DefaultButton="imgbtnBuscarTipoActivo"> 
                                    <div class="row pt-2">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="input-group">
                                                ...
                                                &nbsp;
                                                <asp:ImageButton ID="imgbtnBuscarTipoActivo" runat="server" Height="18px" TabIndex="3" CssClass="mt-1"
                        ...
                        <asp:UpdatePanel ID="updpnlTab2" runat="server">
                            ...
                            <asp:Panel ID="pnlGeneral" runat="server" CssClass="container">
                                <div class="col-12 mt-2">
                                    <h3 class="h5">Mantenimiento de Tipo de Activo</h3>
                                </div>
                                <div class="mt-2">
                                    <div class="row">
                                        <div class="col-lg-9 col-md-8 col-sm-9 pt-md-2 pt-sm-1">
                                            <div class="row">
                                                <div class="col-lg-3 col-md-4 col-sm-5">
                                                    ...
                                                    <div class="input-group">
                                                        <asp:TextBox ID="txtIdTipoActivo" runat="server" CssClass="form-control form-control-sm" TabIndex="10"
                                                ...
                                                <div class="col-lg-9 col-md-12 col-sm-12 pt-1">
                                                    ...
                                                    <div class="input-group">
                                                        <asp:TextBox ID="txtDescripcion" runat="server" CssClass="form-control form-control-sm" TabIndex="11"
                                                            style="text-transform :uppercase" placeholder="Descripción Tipo Activo"></asp:TextBox>
                                                ...
                                                <div class="col-lg-8 col-md-8 col-sm-12 pt-1">
                                                    ...
                                                    <div class="input-group">
                                                        <asp:TextBox ID="txtDescripcionAbreviada" runat="server" CssClass="form-control form-control-sm" TabIndex="12"
                                                            style="text-transform : uppercase" placeholder="Descripción Abreviada Tipo de Activo"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
