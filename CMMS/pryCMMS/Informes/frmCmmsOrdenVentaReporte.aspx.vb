...
Public Class frmCmmsOrdenVentaReporte
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            Me.CrystalReportSource1.ReportDocument.FileName = Request.ServerVariables("APPL_PHYSICAL_PATH") & "Informes\crpCmmsOrdenVentaAlmacen.rpt"
            ...
            Me.CrystalReportSource1.ReportDocument.SetParameterValue("@cTieneOrdenFabricacion", Request.QueryString("TieneOF"))
            Me.CrystalReportSource1.ReportDocument.SetParameterValue("@vOrdenFabricacion", Request.QueryString("NroOF"))
