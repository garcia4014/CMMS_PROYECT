...
Public Class frmCmmsContratoProgramacionReporte
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            Me.CrystalReportSource1.ReportDocument.FileName = Request.ServerVariables("APPL_PHYSICAL_PATH") & "Informes\crpCmmsContratoProgramacion.rpt"
            ...
            Me.CrystalReportSource1.ReportDocument.SetParameterValue("@cFechaInicial", Request.QueryString("FecIni"))
            Me.CrystalReportSource1.ReportDocument.SetParameterValue("@cFechaFinal", Request.QueryString("FecFin"))
            Me.CrystalReportSource1.ReportDocument.SetParameterValue("@vIdEquipos", Replace(Request.QueryString("NroEquipos"), ",", "', '"))
