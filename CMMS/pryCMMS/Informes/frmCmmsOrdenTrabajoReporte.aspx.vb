...
Public Class frmCmmsOrdenTrabajoReporte
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            Dim OT = OTNeg.OrdenTrabajoListarPorId(Request.QueryString("TipDoc"), Request.QueryString("NroSerie"), Request.QueryString("NroDoc"), Session("IdEmpresa"))

            If OT.cIdTipoControlTiempoCabeceraOrdenTrabajo.ToString.Trim = "C" Or OT.cIdTipoControlTiempoCabeceraOrdenTrabajo.ToString.Trim = "" Then 'Por Componentes
                Me.CrystalReportSource1.ReportDocument.FileName = Request.ServerVariables("APPL_PHYSICAL_PATH") & "Informes\crpCmmsOrdenTrabajo.rpt"
            Else
                Me.CrystalReportSource1.ReportDocument.FileName = Request.ServerVariables("APPL_PHYSICAL_PATH") & "Informes\crpCmmsOrdenTrabajoControlTiempoOT.rpt"
            End If
