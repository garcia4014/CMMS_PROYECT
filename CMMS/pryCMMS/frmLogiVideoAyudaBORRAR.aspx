<%@ Page Title="" Language="vb" AutoEventWireup="false" EnableEventValidation="false" MasterPageFile="~/PM_Cmms.Master" CodeBehind="frmLogiVideoAyudaBORRAR.aspx.vb" Inherits="pryCMMS.frmLogiVideoAyuda" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cuerpo" runat="server">
                        ...
                        <div class="tab-content" style="padding-top: 10px">
                            <div role="tabpanel" class="tab-pane active" id="tab1">
                                <%--<asp:UpdatePanel ID="updpnlTab1" runat="server">
                                    ...
                                    Si lo coloco aquì refresca toda la grilla al dar click en el botón imgbtnBuscarVideos y se pierde el 
                                    formato de la clase youtube.
                                    />--%>
                                                                      ...
                                                                      <div class="nav gap-2" role="tablist">
                                                                        <div class="dropdown font-sans-serif btn-reveal-trigger">
                                                                          ...
                                                                          <div class="dropdown-menu dropdown-menu-end py-0" aria-labelledby="OpcionesEquipo">
                                                                              <asp:LinkButton ID="lnkbtnEditarVideo" runat="server" CommandName="EditarVideo"  ToolTip="Editar datos del video" Text="<span class='fas fa-file me-2'></span>Editar" CssClass="nav-link nav-link-card-details" CausesValidation="false" />
                                                                          </div>
                                                                        </div>
                                                                      </div>
                                                                    </div>
    ...
    <script type="text/javascript" language="javascript">
        ...
        /*
        //Función para deshabilitar el uso del ENTER
