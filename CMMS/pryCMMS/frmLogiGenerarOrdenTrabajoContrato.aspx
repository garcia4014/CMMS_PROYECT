<%@ Page Title="" Language="vb" AutoEventWireup="false" EnableEventValidation="false" MasterPageFile="~/PM_Cmms.Master" CodeBehind="frmLogiGenerarOrdenTrabajoContrato.aspx.vb" Inherits="pryCMMS.frmLogiGenerarOrdenTrabajoContrato" ValidateRequest="false" %>
                        ...
                        <div class="row flex-between-end">
                            <div class="col-auto align-self-center">
                                <div class="nav nav-pills gap-2" role="tablist">
                                    <h5 class="mb-0" data-anchor="data-anchor">Listado de Ordenes de Trabajo por Contrato</h5>
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="grdLista" runat="server" AutoGenerateColumns="False" TabIndex="4" DataKeyNames="IdNumeroCorrelativo"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="IdEquipo" HeaderText="Id.Equipo" DataFormatString="{0:dd/MM/yyyy}" HeaderStyle-CssClass="bg-200 text-900 p-1 m-0 small" ItemStyle-CssClass="small"/>
                                    ...
                                    <div class="col-lg-12 col-sm-12">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4 mt-2">
                                                ...
                                                <div class="input-group">
                                                    <p class="fs--1 m-0">
                                                        <asp:Label ID="lblIdEquipo" runat="server" Text="" CssClass="text-500 small"></asp:Label></p>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-4 mt-2">
                                                <span class="far fa-address-card"></span>
                                                ...
                                                <div class="input-group">
                                                    <p class="fs--1 m-0">
                                                        <asp:Label ID="lblDescripcionEquipo" runat="server" Text="" CssClass="text-500 small"></asp:Label></p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-4 col-md-2 mt-2">
                                                ...
                                                <div class="input-group">
                                                    <p class="fs--1 m-0">
                                                        <asp:Label ID="lblNroSerieEquipo" runat="server" Text="" CssClass="text-500 small"></asp:Label></p>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-2 mt-2">
                                                <span class="far fa-address-card"></span>
                                                ...
                                                <div class="input-group">
                                                    <p class="fs--1 m-0">
                                                        <asp:Label ID="lblNroParteEquipo" runat="server" Text="" CssClass="text-500 small"></asp:Label></p>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-2 mt-2">
                                                <div class="mt-1">
                                                    <asp:Label ID="lblIdentificadorComponente" runat="server" CssClass="text-black-50 col-form-label col-form-label-sm fs--2 fw-semi-bold" Text="¿Es un componente?:"></asp:Label></div>
                                                <div class="input-group">
                                            ...
                                            <div class="col-lg-4 col-md-2 mt-2">
                                                ...
                                                <div class="input-group">
                                                    <p class="fs--1 m-0">
                                                        <asp:Label ID="lblTipoActivoEquipo" runat="server" Text="" CssClass="text-500 small"></asp:Label></p>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-2 mt-2">
                                                <span class="far fa-clone"></span>
                                                ...
                                                <div class="input-group">
                                                    <p class="fs--1 m-0">
                                                        <asp:Label ID="lblCatalogoEquipo" runat="server" Text="" CssClass="text-500 small"></asp:Label></p>
                                                </div>
                                            </div>
                                            <div id="divSistemaFuncional" runat="server" class="col-lg-4 col-md-2 mt-2">
                                                ...
                                                <div class="input-group">
                                                    <p class="fs--1 m-0">
                                                        <asp:Label ID="lblSistemaFuncionalEquipo" runat="server" Text="" CssClass="text-500 small"></asp:Label></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                  ...
                                  <div class="row g-0 align-items-center py-2 position-relative border-bottom border-200">
								    <div class="col ps-card py-1 position-static">
								      <div class="d-flex align-items-center">
									    ...
									    <div class="flex-1">
									      <h6 class="mb-0 d-flex align-items-center"><a class="text-800 stretched-link" href="#!"><%# Eval("DescripcionEquipo") %></a><span class="badge rounded-pill ms-2 bg-200 text-primary"><%# Eval("PorcentajeText") %></span></h6>
									    </div>
								      </div>
								    </div>
								    <div class="col py-1">
                                                    ...
                                                    <div class="col-3 col-xl-2 col-lg-3 col-md-2 col-sm-2">
                                                        <div class="overflow-hidden">
                                                            <div class="position-relative rounded-top overflow-hidden">
                                                                <div class="p-1"><a href='<%# "Imagenes/check-" & Eval("StatusCheckList") & ".png" %> ' data-gallery="gallery-1">
                                                                    <img class="img-fluid rounded" src='<%# "Imagenes/check-" & Eval("StatusCheckList") & ".png" %> ' alt="" /></a></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                ...
                                                                <div class="col-xl-12 col-md-12">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-xl-8 col-lg-7">
                                                                            <p class="fs--1 m-0">
                                                                                <asp:Label ID="lblComponente" runat="server" Text='<%# Eval("DescripcionCatalogo") %>' CssClass="text-500 small"></asp:Label></p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-xl-12 col-md-12">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-xl-8 col-lg-7">
                                                                            <p class="fs--1 m-0">
                                                                                <asp:Label ID="lblTipoActivo" runat="server" Text='<%# Eval("DescripcionTipoActivo") %>' CssClass="text-500 small"></asp:Label></p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-xl-12 col-md-12">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-xl-8 col-lg-7">
                                                                            <p class="fs--1 m-0">
                                                                                <asp:Label ID="lblSistemaFuncional" runat="server" Text='<%# Eval("DescripcionSistemaFuncional") %>' CssClass="text-500 small"></asp:Label></p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                 <div class="col-xl-12 col-md-12">
                                                                    ...
                                                                    <div class="border rounded-1 h-100 d-flex flex-column justify-content-between pb-3">
                                                                        <div class="overflow-hidden">
                                                                            ...
                                                                            <div class="p-3">
                                                                                ...
                                                                                <p class="fs--1 mb-3">
                                                                                    <asp:Label ID="lblDescripcion" runat="server" Text='<%# Eval("Descripcion") %>' CssClass="mgrid_small text-500"></asp:Label></p>
                                                                                <p class="fs--1 mb-1">
                                                                                    <asp:Label ID="lblObservacion" runat="server" CssClass="mgrid_tipo_afectacion" Text='<%# Eval("Observacion") %>'></asp:Label></p>
                                                                                <!-- Botón Eliminar -->
                ...
                <div class="modal-dialog modal-sm">
                    <div class="shadow rounded">
                        <div class="modal-dialog-scrollable">
                            <div class="modal-content">
                                <div class="modal-header bg-light">
                                    <h4 class="modal-title" id="myModalLabelVerImagenActividadImagen">Ver Imagen</h4>
                                            ...
                                            <div class="col-lg-6 col-sm-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-12 mt-2">
                                                        ...
                                                        <div class="input-group">
                                                            <p class="fs--1 m-0">
                                                                <asp:Label ID="lblDescripcionEquipoCaracteristicaOtrosDatos" runat="server" Text="" CssClass="text-500 small"></asp:Label></p>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 mt-2">
                                                        <span class="far fa-address-card"></span>
                                                        ...
                                                        <div class="input-group">
                                                            <p class="fs--1 m-0">
                                                                <asp:Label ID="lblDescripcionActividadCaracteristicaOtrosDatos" runat="server" Text="" CssClass="text-500 small"></asp:Label></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
