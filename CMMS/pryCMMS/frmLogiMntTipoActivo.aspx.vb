...
Public Class frmLogiMntTipoActivo
    ...
    Sub ListarFiltroBusquedaCombo()
        ...
        cboFiltro.DataSource = FiltroNeg.TablaSistemaListarCombo("52", "LOGI", Session("IdEmpresa"))
        cboFiltro.Items.Clear()
        cboFiltro.DataBind()
    End Sub

    Sub ActivarObjetos(ByVal bActivar As Boolean)
        txtIdTipoActivo.Enabled = False
    ...
    Sub LlenarData()
        Try
            Dim TipoActivo As LOGI_TIPOACTIVO = TipoActivoNeg.TipoActivoListarPorId(grdLista.SelectedRow.Cells(1).Text)
            txtIdTipoActivo.Text = TipoActivo.cIdTipoActivo
            txtDescripcion.Text = TipoActivo.vDescripcionTipoActivo
            txtDescripcionAbreviada.Text = TipoActivo.vDescripcionAbreviadaTipoActivo
            hfdEstado.Value = IIf(TipoActivo.bEstadoRegistroTipoActivo = False, "0", "1")
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Me.IsPostBack = False Then 'Si la pagina no a hecho Postback; es el ida y vuelta de la pagina web al SRVPRD web
            strOpcionModulo = "077" 'Mantenimiento de los Tipo Activos.
        ...
        Else
            cboFiltro.Attributes.Add("onkeypress", "CambiaFoco('cuerpo_TabContTipoActivo_TabPanListado_txtBuscar')")
            txtBuscar.Attributes.Add("onkeypress", "CambiaFoco('cuerpo_TabContTipoActivo_TabPanListado_imgbtnBuscarTipoActivo')")
            imgbtnBuscarTipoActivo.Attributes.Add("onkeypress", "CambiaFoco('cuerpo_TabContTipoActivo_TabPanListado_grdLista')")
            grdLista.Attributes.Add("onkeypress", "CambiaFoco('cuerpo_TabContTipoActivo_TabPanGeneral_txtIdTipoActivo')")
            txtIdTipoActivo.Attributes.Add("onkeypress", "CambiaFoco('cuerpo_TabContTipoActivo_TabPanGeneral_txtDescripcion')")
            txtDescripcion.Attributes.Add("onkeypress", "CambiaFoco('cuerpo_TabContTipoActivo_TabPanGeneral_txtDescripcionAbreviada')")
            txtDescripcionAbreviada.Attributes.Add("onkeypress", "CambiaFoco('cuerpo_TabContTipoActivo_TabPanGeneral_imgbtnGuardar')")
        End If
    End Sub
    ...
    Protected Sub grdLista_RowCommand(sender As Object, e As GridViewCommandEventArgs)
        Try
            If e.CommandName = "Activar" Then
                ...
                If Session("IdTipoUsuario") = "U" And FuncionesNeg.ValidaPerfil(Session("IdUsuario"), Session("IdPerfil"), "0366", strOpcionModulo, Session("IdSistema")) Then
                ...
                TipoActivo.cIdTipoActivo = Valores(0).ToString()
                ...
                TipoActivoNeg.TipoActivoGetData("UPDATE LOGI_TIPOACTIVO SET bEstadoRegistroTipoActivo = 0 WHERE cIdTipoActivo = '" & TipoActivo.cIdTipoActivo & "'") ' AND cIdEmpresa = '" & Producto.cIdEmpresa & "' AND cIdPuntoVenta = '" & Producto.cIdPuntoVenta & "'")
                Session("Query") = "UPDATE LOGI_TIPOACTIVO SET bEstadoRegistroTipoActivo = 0 WHERE cIdTipoActivo = '" & TipoActivo.cIdTipoActivo & "'" '"' AND cIdEmpresa = '" & Producto.cIdEmpresa & "' AND cIdPuntoVenta = '" & Producto.cIdPuntoVenta & "'"
                LogAuditoria.vEvento = "DESACTIVAR ACTIVO"
            ...
            If e.CommandName = "Desactivar" Then 'Utilizado para enviar como modificado cuando no recepcionó correctamente la Sunat
                ...
                TipoActivoNeg.TipoActivoGetData("UPDATE LOGI_TIPOACTIVO SET bEstadoRegistroTipoActivo = 1 WHERE cIdTipoActivo = '" & TipoActivo.cIdTipoActivo & "'") ' AND cIdEmpresa = '" & Producto.cIdEmpresa & "' AND cIdPuntoVenta = '" & Producto.cIdPuntoVenta & "'")
                Session("Query") = "UPDATE LOGI_TIPOACTIVO SET bEstadoRegistroTipoActivo = 1 WHERE cIdTipoActivo = '" & TipoActivo.cIdTipoActivo & "'" ' AND cIdEmpresa = '" & Producto.cIdEmpresa & "' AND cIdPuntoVenta = '" & Producto.cIdPuntoVenta & "'"
                LogAuditoria.vEvento = "ACTIVAR TIPO ACTIVO"
                LogAuditoria.vQuery = Session("Query")
                LogAuditoria.cIdSistema = Session("IdSistema")
                LogAuditoria.cIdModulo = strOpcionModulo
    ...
    Private Sub imgbtnBuscarTipoActivo_Click(sender As Object, e As ImageClickEventArgs) Handles imgbtnBuscarTipoActivo.Click
        Me.grdLista.DataSource = TipoActivoNeg.TipoActivoListaBusqueda(cboFiltro.SelectedValue, txtBuscar.Text, IIf(Session("IdTipoUsuario") = "A", "*", "1"))
        Me.grdLista.DataBind()
    End Sub
    ...
    Protected Sub btnNuevo_Click(sender As Object, e As EventArgs) Handles btnNuevo.Click
        Try
            ...
            MyValidator.ErrorMessage = ""
            fValidarSesion() 'Se utiliza en el caso cambie de empresa para otra página.
            FuncionesNeg.ValidaPerfil(Session("IdUsuario"), Session("IdPerfil"), "0362", strOpcionModulo, Session("IdSistema"))
    ...
    Protected Sub btnEditar_Click(sender As Object, e As EventArgs) Handles btnEditar.Click
        Try
            ...
            MyValidator.ErrorMessage = ""
            fValidarSesion() 'Se utiliza en el caso cambie de empresa para otra página.
            FuncionesNeg.ValidaPerfil(Session("IdUsuario"), Session("IdPerfil"), "0363", strOpcionModulo, Session("IdSistema"))
    ...
    Protected Sub btnDeshacer_Click(sender As Object, e As EventArgs) Handles btnDeshacer.Click
        Try
            ...
            MyValidator.ErrorMessage = ""
            fValidarSesion() 'Se utiliza en el caso cambie de empresa para otra página.
            FuncionesNeg.ValidaPerfil(Session("IdUsuario"), Session("IdPerfil"), "0365", strOpcionModulo, Session("IdSistema"))
    ...
    Protected Sub btnGuardar_Click(sender As Object, e As EventArgs) Handles btnGuardar.Click
        Try
            ...
            Dim TipoActivo As New LOGI_TIPOACTIVO
            TipoActivo.cIdTipoActivo = txtIdTipoActivo.Text
            TipoActivo.vDescripcionTipoActivo = UCase(IIf(txtDescripcion.Text = "", "", txtDescripcion.Text))
            TipoActivo.vDescripcionAbreviadaTipoActivo = UCase(IIf(txtDescripcionAbreviada.Text = "", "", txtDescripcionAbreviada.Text))
