...
Public Class crpCmmsFichaEquipo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "pryCMMS.crpCmmsFichaEquipo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpCmmsFichaEquipo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpCmmsFichaEquipo = New crpCmmsFichaEquipo()
        rpt.Site = Me.Site
        Return rpt
    End Function
