...
Public Class frmCmmsEquipoOrdenTrabajoReporte
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            Me.CrystalReportSource1.ReportDocument.FileName = Request.ServerVariables("APPL_PHYSICAL_PATH") & "Informes\crpCmmsFichaEquipoOrdenTrabajo.rpt"
            ...
            Me.CrystalReportSource1.ReportDocument.SetParameterValue("@cIdEquipo", Request.QueryString("IdEqu"))
