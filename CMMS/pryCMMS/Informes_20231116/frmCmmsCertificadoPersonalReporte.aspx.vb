...
Public Class frmCmmsCertificadoPersonalReporte
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            Me.CrystalReportSource1.ReportDocument.FileName = Request.ServerVariables("APPL_PHYSICAL_PATH") & "Informes\crpCmmsCertificadoPersonal.rpt"
            ...
            Me.CrystalReportSource1.ReportDocument.SetParameterValue("@cIdPersonal", Request.QueryString("IdPersonal"))
