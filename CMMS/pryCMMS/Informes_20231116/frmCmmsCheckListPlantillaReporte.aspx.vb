...
Public Class frmCmmsCheckListPlantillaReporte
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            Me.CrystalReportSource1.ReportDocument.FileName = Request.ServerVariables("APPL_PHYSICAL_PATH") & "Informes\crpCmmsCheckListPlantilla.rpt"
            ...
            Me.CrystalReportSource1.ReportDocument.SetParameterValue("@cIdTipoMantenimiento", Request.QueryString("IdTipMan"))
            Me.CrystalReportSource1.ReportDocument.SetParameterValue("@cIdNumeroCabeceraCheckListPlantilla", Request.QueryString("IdNroDoc"))
