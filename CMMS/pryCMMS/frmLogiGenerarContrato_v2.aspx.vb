...
Public Class frmLogiGenerarContrato_v2
    ...
    Sub CargarCestaEquipos()
        ...
        Try
            ...
            grdDetalleEquipos_Load(grdDetalleEquipos_v2, New System.EventArgs)
            ...
            For Each ListaEquipos In dsEquipos.Rows
                ...
                'AgregarCestaEquipo(False, ListaEquipos("nIdNumeroItemDetalleContrato"), ListaEquipos("cIdEquipoDetalleContrato"), ListaEquipos("vDescripcionDetalleContrato"), ListaEquipos("bEstadoRegistroDetalleContrato"), strNombreColumna, strDatosColumna, Session("CestaEquipoContrato2"))
                AgregarCestaEquipo(False, ListaEquipos("nIdNumeroItemDetalleContrato"), ListaEquipos("cIdEquipoDetalleContrato"), ListaEquipos("vDescripcionDetalleContrato"), ListaEquipos("bEstadoRegistroDetalleContrato"), strNombreColumna, Session("CestaEquipoContrato2"))
            Next
            Me.grdDetalleEquipos_v2.DataSource = Session("CestaEquipoContrato2")

            Me.grdDetalleEquipos_v2.DataBind()
    ...
    Protected Sub btnNuevo_Click(sender As Object, e As EventArgs) Handles btnNuevo.Click
        Try
            ...
            LimpiarObjetos()
            ValidarTexto(True) '
            Me.rfvFechaVigenciaInicio.EnableClientScript = True
            Me.rfvFechaVigenciaFinal.EnableClientScript = True
            txtFechaVigenciaInicio.Enabled = True
            txtFechaVigenciaFinal.Enabled = True
            lnkbtnExtenderVigencia.Visible = False
        ...
        Try
            ...
            If hfdOperacion.Value = "N" Then
                If (ContratoNeg.ContratoInserta(Contrato)) = 0 Then
                    ...
                    For i = 0 To Session("CestaEquipoContrato2").Rows.Count - 1
                        ...
                        DetContrato.nIdNumeroItemDetalleContrato = Session("CestaEquipoContrato2").rows(i)("Item")
                        DetContrato.cIdEquipoDetalleContrato = Session("CestaEquipoContrato2").rows(i)("IdEquipo")
                        DetContrato.vDescripcionDetalleContrato = Session("CestaEquipoContrato2").rows(i)("DescripcionEquipo")
                        DetContrato.bEstadoRegistroDetalleContrato = Session("CestaEquipoContrato2").rows(i)("Estado")
                    ...
                    Dim conVigencia = New LOGI_CONTRATOVIGENCIA
                    conVigencia.cIdTipoDocumentoCabeceraContrato = Contrato.cIdTipoDocumentoCabeceraContrato
                    conVigencia.vIdNumeroSerieCabeceraContrato = Contrato.vIdNumeroSerieCabeceraContrato
                    conVigencia.vIdNumeroCorrelativoCabeceraContrato = Contrato.vIdNumeroCorrelativoCabeceraContrato
                    conVigencia.cIdEmpresa = Session("IdEmpresa")
                    conVigencia.dFechaVigenciaInicialCabeceraContrato = txtFechaVigenciaInicio.Text
                    conVigencia.dFechaVigenciaFinalCabeceraContrato = txtFechaVigenciaFinal.Text
                    conVigencia.bEstadoActivoVigencia = True

                    ContratoNeg.ContratoVigenciaInserta(conVigencia)
    ...
    'agregar validacion de los periodos
    Protected Sub btnAceptarVigenciaContrato_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAceptarVigenciaContrato.Click

        Try
            If TextBox1.Text = "" Then
                Throw New Exception("Debe de ingresar la fecha de inicio de vigencia.")
            ElseIf TextBox2.Text = "" Then
                Throw New Exception("Debe de ingresar la fecha de termino de vigencia.")

            ElseIf DateTime.Parse(TextBox2.Text) < DateTime.Parse(TextBox1.Text) Then
                Throw New Exception("La fecha de termino de vigencia no puede ser menor a la de inicio.")

            End If

            MyValidator.ErrorMessage = ""
            Dim contrato = New LOGI_CONTRATOVIGENCIA
            contrato.cIdTipoDocumentoCabeceraContrato = grdLista.SelectedRow.Cells(0).Text
            contrato.vIdNumeroSerieCabeceraContrato = grdLista.SelectedRow.Cells(1).Text
            contrato.vIdNumeroCorrelativoCabeceraContrato = grdLista.SelectedRow.Cells(2).Text
            contrato.cIdEmpresa = Session("IdEmpresa")
            contrato.dFechaVigenciaInicialCabeceraContrato = TextBox1.Text
            contrato.dFechaVigenciaFinalCabeceraContrato = TextBox2.Text
            contrato.bEstadoActivoVigencia = True

            ContratoNeg.ContratoVigenciaInserta(contrato)

            'gdrlLista()
            MyValidator.ErrorMessage = "Transacción registrada con éxito"
            txtFechaVigenciaInicio.Text = TextBox1.Text
            txtFechaVigenciaFinal.Text = TextBox2.Text
            ...
            Me.Page.Validators.Add(MyValidator)
        Catch ex As Exception
            'lnk_mostrarPanelVigenciaContrato_ModalPopupExtender.Show()
    ...
    Protected Sub btnCancelarVigenciaContrato_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnCancelarVigenciaContrato.Click

        Dim list = ContratoNeg.ContratoVigenciaLista(grdLista.SelectedRow.Cells(0).Text, grdLista.SelectedRow.Cells(1).Text, grdLista.SelectedRow.Cells(2).Text, Session("IdEmpresa"))
        If (list.Count > 0) Then
            If Not list.Any(Function(x) x.bEstadoActivoVigencia = True) Then
                lnk_mostrarPanelVigenciaContrato_ModalPopupExtender.Show()
                Return
            End If
        End If

        'updpnlContenido.Update()
        lnk_mostrarPanelVigenciaContrato_ModalPopupExtender.Hide()
    ...
    Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As GridViewCommandEventArgs) Handles GridView1.RowCommand
        Try
            ...
            Dim cIdTipoDocumentoCabeceraContrato = grdLista.SelectedRow.Cells(0).Text
            Dim vIdNumeroSerieCabeceraContrato = grdLista.SelectedRow.Cells(1).Text
            Dim vIdNumeroCorrelativoCabeceraContrato = grdLista.SelectedRow.Cells(2).Text
            Dim cIdEmpresa = Session("IdEmpresa")
            ...
            If e.CommandName = "Activar" Then
                Dim query As String = "UPDATE LOGI_CONTRATOVIGENCIA SET bEstadoActivoVigencia = 0 WHERE " &
                                                            "cIdTipoDocumentoCabeceraContrato = '" & cIdTipoDocumentoCabeceraContrato &
                                                            "' AND vIdNumeroSerieCabeceraContrato = '" & vIdNumeroSerieCabeceraContrato &
                                                            "' AND vIdNumeroCorrelativoCabeceraContrato = '" & vIdNumeroCorrelativoCabeceraContrato &
                                                            "' AND cIdEmpresa = '" & cIdEmpresa & "' AND Id = " & Integer.Parse(Valores(0).ToString()) & ""

                ContratoNeg.ContratoVigenciaQuery(query)


            ElseIf e.CommandName = "Desactivar" Then
                Dim query1 As String = "UPDATE LOGI_CONTRATOVIGENCIA SET bEstadoActivoVigencia = 0 WHERE " &
                                                           "cIdTipoDocumentoCabeceraContrato = '" & cIdTipoDocumentoCabeceraContrato &
                                                           "' AND vIdNumeroSerieCabeceraContrato = '" & vIdNumeroSerieCabeceraContrato &
                                                           "' AND vIdNumeroCorrelativoCabeceraContrato = '" & vIdNumeroCorrelativoCabeceraContrato &
                                                           "' AND cIdEmpresa = '" & cIdEmpresa & "'"

                Dim query2 As String = "UPDATE LOGI_CONTRATOVIGENCIA SET bEstadoActivoVigencia = 1 WHERE " &
                                                           "cIdTipoDocumentoCabeceraContrato = '" & cIdTipoDocumentoCabeceraContrato &
                                                           "' AND vIdNumeroSerieCabeceraContrato = '" & vIdNumeroSerieCabeceraContrato &
                                                           "' AND vIdNumeroCorrelativoCabeceraContrato = '" & vIdNumeroCorrelativoCabeceraContrato &
                                                           "' AND cIdEmpresa = '" & cIdEmpresa & "' AND Id = " & Integer.Parse(Valores(0).ToString()) & ""

                Dim query3 As String = "UPDATE [dbo].[LOGI_CABECERACONTRATO] SET dFechaVigenciaInicialCabeceraContrato = '" & Valores(1).ToString() & "', " &
                                        "dFechaVigenciaFinalCabeceraContrato = '" & Valores(2).ToString() & "' " &
                                        "WHERE cIdTipoDocumentoCabeceraContrato  =  '" & cIdTipoDocumentoCabeceraContrato & "' " &
                                        "And vIdNumeroSerieCabeceraContrato = '" & vIdNumeroSerieCabeceraContrato & "' " &
                                        "And vIdNumeroCorrelativoCabeceraContrato = '" & vIdNumeroCorrelativoCabeceraContrato & "' " &
                                        "And cIdEmpresa = '" & cIdEmpresa & "'"

                ContratoNeg.ContratoVigenciaQuery(query1)
                ContratoNeg.ContratoVigenciaQuery(query2)
                ContratoNeg.ContratoQuery(query3)

                txtFechaVigenciaInicio.Text = Valores(1).ToString()
                txtFechaVigenciaFinal.Text = Valores(2).ToString()

            End If

            Me.GridView1.DataSource = ContratoNeg.ContratoVigenciaLista(grdLista.SelectedRow.Cells(0).Text, grdLista.SelectedRow.Cells(1).Text, grdLista.SelectedRow.Cells(2).Text, Session("IdEmpresa"))
            ...
            '    updpnlContenido.Update() ' Actualizar el UpdatePanel
            'End If
        Catch ex As Exception
    ...
    Private Sub lnkbtnExtenderVigencia_Click(sender As Object, e As EventArgs) Handles lnkbtnExtenderVigencia.Click
        Try
            'FuncionesNeg.ValidaPerfil(Session("IdUsuario"), Session("IdPerbtnAceptarSeleccionarEquipofil"), "0668", strOpcionModulo, "CMMS")
            TextBox1.Text = ""
            TextBox2.Text = ""

            If (String.IsNullOrEmpty(txtIdContrato.Text)) Then
                Me.GridView1.DataBind()
            Else
                Me.GridView1.DataSource = ContratoNeg.ContratoVigenciaLista(grdLista.SelectedRow.Cells(0).Text, grdLista.SelectedRow.Cells(1).Text, grdLista.SelectedRow.Cells(2).Text, Session("IdEmpresa"))
                Me.GridView1.DataBind()
    ...
    Private Sub imgbtnBuscarSeleccionarEquipo_Click(sender As Object, e As ImageClickEventArgs) Handles imgbtnBuscarSeleccionarEquipo.Click
        'Me.grdListaSeleccionarEquipo.DataSource = EquipoNeg.EquipoListaBusqueda("EQU.vContratoReferenciaActualEquipo = '" & txtIdContrato.Text & "' AND ISNULL(EQU.bTieneContratoEquipo, '0') = '0' AND EQU.cIdCliente = '" & hfdIdAuxiliar.Value & "' AND " & cboFiltroSeleccionarEquipo.SelectedValue,
        'JMUG: 06/10/2025
                ...
                If grdListaSeleccionarEquipo.Rows.Count > 0 Then
                    If IsNothing(grdListaSeleccionarEquipo.SelectedRow) = False Then
                        If IsReference(grdListaSeleccionarEquipo.SelectedRow.Cells(1).Text) = True Then
                            ...
                            For i = 0 To Session("CestaEquipoContrato2").Rows.Count - 1
                                If (Session("CestaEquipoContrato2").Rows(i)("IdEquipo").ToString.Trim) = (Server.HtmlDecode(grdListaSeleccionarEquipo.SelectedRow.Cells(1).Text).Trim) Then
                            ...
                            AgregarCestaEquipo(False, "0", grdListaSeleccionarEquipo.SelectedRow.Cells(1).Text, grdListaSeleccionarEquipo.SelectedRow.Cells(4).Text, "1", strNombreColumna, Session("CestaEquipoContrato2"))
                            lblMensajeSeleccionarEquipo.Text = "Equipo asignado satisfactoriamente"
                            grdDetalleEquipos_v2.DataSource = Session("CestaEquipoContrato2")
                            grdDetalleEquipos_v2.DataBind()
                            lnk_mostrarPanelSeleccionarEquipo_ModalPopupExtender.Show()
                        End If
                    End If
    ...
    Private Sub grdDetalleEquipos_Load(sender As Object, e As EventArgs) Handles grdDetalleEquipos_v2.Load
        'grdDetalleEquipos.Width = 500
        'For i = 0 To 30
    ...
    Private Sub grdDetalleEquipos_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles grdDetalleEquipos_v2.RowDataBound
    ...
    Private Sub btnAceptarMantenimientoOrdenTrabajo_Click(sender As Object, e As EventArgs) Handles btnAceptarMantenimientoOrdenTrabajo.Click
        Try
            ...
            Dim gvRow As GridViewRow = grdDetalleEquipos_v2.Rows(intIndexContratoEquipo - ((grdDetalleEquipos_v2.PageSize) * (grdDetalleEquipos_v2.PageIndex))) 'JMUG: 19/05/2022
            ...
            '    End If
            'Next
            Dim resultProgramacionContratoSimple As DataRow() = Session("CestaEquipoContrato2").Select("IdEquipo = '" & hfdIdEquipo.Value & "'")
    ...
    Private Sub cboPersonalResponsableMantenimientoOrdenTrabajo_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboPersonalResponsableMantenimientoOrdenTrabajo.SelectedIndexChanged
        Try
            ...
            For x = 0 To Session("CestaEquipoContrato2").Rows.Count - 1
                If (Session("CestaEquipoContrato2").Rows(x)("IdEquipo").ToString.Trim) = hfdIdEquipo.Value.Trim Then
                    Dim strNombreColumna As String = ""
                    For i = 1 To 31
                        If IsDate(grdDetalleEquipos_v2.Columns(2 + i).HeaderText) Then
                            If CDate(grdDetalleEquipos_v2.Columns(2 + i).HeaderText) = CDate(txtFechaInicioPlanificadaMantenimientoOrdenTrabajo.Text) Then
                                strNombreColumna = ("D" & i)
                                strValidacion = Session("CestaEquipoContrato2").Rows(x)(strNombreColumna).ToString.Trim
                                Exit For
                            End If
                        Else
                            If strNombreColumna = "" Then
    ...
    Private Sub grdDetalleEquipos_PageIndexChanging(sender As Object, e As GridViewPageEventArgs) Handles grdDetalleEquipos_v2.PageIndexChanging
        grdDetalleEquipos_v2.PageIndex = e.NewPageIndex
        Me.grdDetalleEquipos_v2.DataSource = Session("CestaEquipoContrato2")
        Me.grdDetalleEquipos_v2.DataBind()
        grdDetalleEquipos_v2.SelectedIndex = -1
    End Sub
    ...
    Protected Sub btnEditar_Click(sender As Object, e As EventArgs) Handles btnEditar.Click
        Try
            ...
            If IsNothing(grdLista.SelectedRow) = False Then
                ...
                ValidarTexto(True)
                ActivarObjetos(True)
                Me.rfvFechaVigenciaInicio.EnableClientScript = False
                Me.rfvFechaVigenciaFinal.EnableClientScript = False
                txtFechaVigenciaInicio.Enabled = False
                txtFechaVigenciaFinal.Enabled = False
                lnkbtnExtenderVigencia.Visible = True
    ...
    Private Sub btnSiMensajeDocumento_Click(sender As Object, e As EventArgs) Handles btnSiMensajeDocumento.Click
        Try
            ...
            QuitarCestaEquipo(intIndexContratoEquipo, Session("CestaEquipoContrato2"))
            grdDetalleEquipos_v2.DataSource = Session("CestaEquipoContrato2")
            grdDetalleEquipos_v2.DataBind()
