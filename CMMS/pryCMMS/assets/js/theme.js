...
//JMUG: 04/03/2022 Lo colgué al frmBienvenida.aspx para asignarle valores.
...
var returningCustomerRateInit = function returningCustomerRateInit() {
  ...
  if ($echartsLineReturningCustomerRate) {
    ...
    var monthNumbers = strOrdTrabajoNuevaTerminada;
...
var sessionByBrowserChartInit = function sessionByBrowserChartInit() {
  ...
  if ($sessionByBroswser) {
    ...
    //};
      ...
      var dataset = {
          week: jsondataOrdenTrabajoWeek,
          month: jsondataOrdenTrabajoMonth,
          year: jsondataOrdenTrabajoYear
      };
...
var totalSalesInit = function totalSalesInit() {
  ...
  if ($echartsLineTotalSales) {
    ...
    var monthsnumber = jsondataventastotal1;
      //var monthsnumber = [[60, 80, 60, 80, 65, 130, 120, 100, 30, 40, 30, 70], [100, 70, 80, 50, 120, 100, 130, 140, 90, 100, 40,100, 70, 80, 50, 120, 100, 130, 140, 90, 100, 40, 50], [80, 50, 60, 40, 60, 120, 100, 130, 60, 80, 50, 60], [70, 80, 100, 70, 90, 60, 80, 130, 40, 60, 50, 80], [90, 40, 80, 80, 100, 140, 100, 130, 90, 60, 70, 50], [80, 60, 80, 60, 40, 100, 120, 100, 30, 40, 30, 70], [20, 40, 20, 50, 70, 60, 110, 80, 90, 30, 50, 50], [60, 70, 30, 40, 80, 140, 80, 140, 120, 130, 100, 110], [90, 90, 40, 60, 40, 110, 90, 110, 60, 80, 60, 70], [50, 80, 50, 80, 50, 80, 120, 80, 50, 120, 110, 110], [60, 90, 60, 70, 40, 70, 100, 140, 30, 40, 30, 70], [20, 40, 20, 50, 30, 80, 120, 100, 30, 40, 30, 70]];
    var getDefaultOptions = function getDefaultOptions() {
      return {
        color: utils.getGrays()['100'],
        tooltip: {
...
var weeklySalesInit = function weeklySalesInit() {
  ...
  if ($echartBarWeeklySales) {
    ...
    var data = jsondatasemanal; // Max value of data
...
/*                                Ventas Mensuales 4 Semana - JMUG                                */

/* -------------------------------------------------------------------------- */


//var 4SemanasSalesInit = function 4SemanasSalesInit() {
//    var ECHART_BAR_WEEKLY_SALES = '.echart-bar-weekly-sales';
//    var $echartBarWeeklySales = document.querySelector(ECHART_BAR_WEEKLY_SALES);
