<%@ Page Title="" Language="vb" AutoEventWireup="false" EnableEventValidation="false" MasterPageFile="~/PM_Cmms.Master"
    CodeBehind="frmLogiGenerarContrato_v2.aspx.vb" Inherits="pryCMMS.frmLogiGenerarContrato_v2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cuerpo" runat="server">
                            ...
                            <div class="col-auto ms-auto">
                                <div class="nav gap-2" role="tablist">
                                    ...
                                    <asp:LinkButton ID="btnEditar" runat="server" OnClick="btnEditar_Click"
                                        ...
                                        Text="<span class='fas fa-pencil-alt'></span> Editar"
    ...
    <asp:UpdatePanel ID="updpnlContenido" runat="server" UpdateMode="Conditional">
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="btnCancelarVigenciaContrato" EventName="Click" />
                            ...
                            <div class="col-lg-12 col-sm-12">
                                ...
                                <div class="row" style="margin-top: 10px;">
                                    ...
                                    <div class="col-lg-2 col-md-2">
                                        ...
                                        <label class="text-black-50 col-form-label fs--2 m-1">Periodo Vigencia</label>
                                        <div class="input-group">
                                            <asp:LinkButton ID="lnkbtnExtenderVigencia" runat="server"
                                                Text="<span class='far fa-plus-square'></span>"
                                                CssClass="btn btn-primary btn-sm form-control form-control-sm"
                                                ToolTip="Periodo Vigencia" />

                                            <asp:LinkButton ID="lnk_mostrarPanelVigenciaContrato" runat="server">
                                            </asp:LinkButton>
                                            <ajaxToolkit:ModalPopupExtender
                                                ID="lnk_mostrarPanelVigenciaContrato_ModalPopupExtender" runat="server"
                                                BackgroundCssClass="FondoAplicacion" DropShadow="False"
                                                DynamicServicePath="" Enabled="True"
                                                PopupControlID="pnlVigenciaContrato"
                                                TargetControlID="lnk_mostrarPanelVigenciaContrato">
                                            </ajaxToolkit:ModalPopupExtender>
                                            <asp:Panel ID="pnlVigenciaContrato" runat="server" CssClass="container">
                                                <div class="modal-dialog modal-xl">
                                                    <div class="shadow rounded">
                                                        <div class="modal-dialog-scrollable">
                                                            <div class="modal-content">
                                                                <div class="modal-header bg-light">
                                                                    <h4 class="modal-title"
                                                                        id="myModalLabelVigenciaContrato">Ampliar Vigencia </h4>
                                                                    <%-- <asp:Button
                                                                        ID="imgbtnCancelarVigenciaContratoImagen"
                                                                        runat="server"
                                                                        CssClass="btn-close btn btn-sm btn-circle d-flex flex-center transition-base"
                                                                        data-dismiss="modal" aria-label="Close" />--%>
                                                                </div>
                                                ...
                                                Inicio:</label>
                                                                            <div class="input-group">
                                                                                ...
                                                                                <ajaxToolkit:CalendarExtender
                                                                                    ID="TextBox1_CalendarExtender" runat="server"
                                                                                    CssClass="calendario" Enabled="True"
                                                                        ...
                                                                        <div class="col-lg-3 col-md-3">
                                                                            ...
                                                                            <div class="input-group">
                                                                                ...
                                                                                <ajaxToolkit:CalendarExtender
                                                                                    ID="TextBox2_CalendarExtender" runat="server"
                                                                                    CssClass="calendario" Enabled="True"
                                                                            ...
                                                                            <div style="overflow: auto">
                                                                                        ...
                                                                                        <asp:GridView
                                                                                            ...
                                                                                            <Columns>
                                                                                                ...
                                                                                                <asp:BoundField
                                                                                                    DataField="dFechaVigenciaInicialCabeceraContrato"
                                                                                                    HeaderText="Fecha Vigencia Inicial" DataFormatString="{0:dd/MM/yyyy}"
                                                                                                    HeaderStyle-CssClass="bg-200 text-900" />

                                                                                                <asp:BoundField
                                                                                                    DataField="dFechaVigenciaFinalCabeceraContrato"
                                                                                                    HeaderText="Fecha Vigencia Final" DataFormatString="{0:dd/MM/yyyy}"
                                                                                                    HeaderStyle-CssClass="bg-200 text-900" />
                                                                                                    ...
                                                                                                    <ItemTemplate>
                                                                                                        <div class="bootstrap-switch bootstrap-switch-on bootstrap bootstrap-switch-animate bootstrap-switch-mini">
                                                                                                            <div class="bootstrap-switch-container">
                                                                                                                <asp:LinkButton
                                                                                                                    ID="lnkEstadoDetalleOn"
                                                                                                                    runat="server"
                                                                                                                    CommandName="Activar"
                                                                                                                    CommandArgument='<%#Eval("Id") & "," & Eval("dFechaVigenciaInicialCabeceraContrato") & "," & Eval("dFechaVigenciaFinalCabeceraContrato") %>'
                                                                                                                    CssClass="bootstrap-switch-handle-on bootstrap-switch-primary"
                                                                                                                    Visible='<%# Eval("bEstadoActivoVigencia").ToString() = "True" %>'>
            Activado
                                                                                                                </asp:LinkButton>
                                                                                                                ...
                                                                                                                <asp:LinkButton
                                                                                                                    ID="lnkEstadoDetalleOff"
                                                                                                                    runat="server"
                                                                                                                    CommandName="Desactivar"
                                                                                                                    CommandArgument='<%#Eval("Id") & "," & Eval("dFechaVigenciaInicialCabeceraContrato") & "," & Eval("dFechaVigenciaFinalCabeceraContrato") %>'
                                                                                                                    CssClass="bootstrap-switch-handle-off bootstrap-switch-danger"
                                                                                                                    Visible='<%# Eval("bEstadoActivoVigencia").ToString() = "False" %>'>
            Inactivado
                                                                                                                </asp:LinkButton>
                                                                                                            </div>
                                                                                                        </div>
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <asp:Button ID="btnAceptarVigenciaContrato"
                                                                        runat="server"
                                                                    ...
                                                                    &nbsp;
                                                                    <asp:Button ID="btnCancelarVigenciaContrato"
                ...
                <div class="card">
                    <div class="card-header bg-light">
                        <div class="row align-items-center">
                            <div class="row">
                                <div class="col-lg-5 col-md-4 mt-2" hidden>
                        ...
                        <div class="modal-dialog modal-xl">
                            <div class="shadow rounded">
                                <div class="modal-dialog-scrollable">
                                    <div class="modal-content">
                                        <div class="modal-header bg-light">
                                            <h4 class="modal-title" id="myModalLabelOrdenTrabajo">Mantenimiento
                                                    Orden de Trabajo</h4>
                                                ...
                                                <div class="scrollbar" style="height: 380px;">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-2 col-md-2 mt-2">
                                                            ...
                                                            <label
                                                                class="text-black-50 col-form-label fs--2 m-1">
                                                                Nro.Ord.Trab.Cliente:</label>
                                                            <div class="input-group">
                                                                <asp:TextBox
                                                                    ID="txtNroOTClienteMantenimientoOrdenTrabajo"
                                                                    runat="server"
                                                                    CssClass="form-control form-control-sm"
                                                                    TabIndex="11" Style="text-transform: uppercase"
                                                                    placeholder="Número del contrato asignado por el cliente">
                                                                </asp:TextBox>
                                                            </div>
                                                        </div>
                    ...
                    <div class="card-body h-100">
                        <div class="row justify-content-between mt-3">
                            <div class="col-md-12 col-lg-12 col-xl-12 mb-4 mb-lg-0">
                                <div id="divGridDetalleAgregarEquipos"
                                    style="overflow: auto; height: 560px; align: left;" class="scrollbar">
                                    <asp:Panel ID="pnlDetalleEquipos" runat="server" CssClass="bg-light">
                                        <div class="table-responsive scrollbar">
                                            <asp:GridView ID="grdDetalleEquipos_v2" runat="server"
                                                AutoGenerateColumns="False" TabIndex="10" GridLines="None"
                                                CssClass="table table-striped table-hover small overflow-hidden"
                                                AllowPaging="True" EmptyDataText="No hay registros a visualizar"
                                                PageSize="10" OnRowCommand="grdDetalleEquipos_RowCommand_Botones">
                                                <PagerStyle CssClass="mGrid" />
                                                <SelectedRowStyle BackColor="#E2DED6" Font-Bold="True"
                                                    ForeColor="#333333" />
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Mant."
                                                        HeaderStyle-CssClass="bg-200 text-900 p-1 m-0 small" Visible="false">
                                                        <%--<ItemTemplate>
                                                    ...
                                                    <%--<asp:BoundField DataField="IdEquipo" HeaderText="Código"
                                                        HeaderStyle-CssClass="bg-200 text-900 p-1 m-0 small" />--%>
                                                    ...
                                                    <%--<asp:TemplateField Visible="false"
                                                        HeaderStyle-CssClass="bg-200 text-900 p-1 m-0 small">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkbtnD1" runat="server"
                                                                Text='<%# IIf(IsNothing(Eval("D1")), "", Split(Eval("D1").ToString, "|")(0)) %>'
                                                    ...
                                                    <asp:TemplateField Visible="false"
                                                        HeaderStyle-CssClass="bg-200 text-900 p-1 m-0 small">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkbtnD2" runat="server"
                                                                Text='<%# IIf(IsNothing(Eval("D2")), "", Split(Eval("D2").ToString, "|")(0)) %>'
                                                                ToolTip="Editar Mantenimiento"
                                                                CommandName="VerMantenimientoPlanificacionEquipo"
                                                    ...
                                                    <asp:TemplateField Visible="false"
                                                        HeaderStyle-CssClass="bg-200 text-900 p-1 m-0 small">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkbtnD3" runat="server"
                                                                Text='<%# IIf(IsNothing(Eval("D3")), "", Split(Eval("D3").ToString, "|")(0)) %>'
                                                                ToolTip="Editar Mantenimiento"
                                                                CommandName="VerMantenimientoPlanificacionEquipo"
                                                    ...
                                                    <asp:TemplateField Visible="false"
                                                        HeaderStyle-CssClass="bg-200 text-900 p-1 m-0 small">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkbtnD4" runat="server"
                                                                Text='<%# IIf(IsNothing(Eval("D4")), "", Split(Eval("D4").ToString, "|")(0)) %>'
                                                                ToolTip="Editar Mantenimiento"
                                                                CommandName="VerMantenimientoPlanificacionEquipo"
                                                    ...
                                                    <asp:TemplateField Visible="false"
                                                        HeaderStyle-CssClass="bg-200 text-900 p-1 m-0 small">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkbtnD5" runat="server"
                                                                Text='<%# IIf(IsNothing(Eval("D5")), "", Split(Eval("D5").ToString, "|")(0)) %>'
                                                                ToolTip="Editar Mantenimiento"
                                                                CommandName="VerMantenimientoPlanificacionEquipo"
                                                    ...
                                                    <asp:TemplateField Visible="false"
                                                        HeaderStyle-CssClass="bg-200 text-900 p-1 m-0 small">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkbtnD6" runat="server"
                                                                Text='<%# IIf(IsNothing(Eval("D6")), "", Split(Eval("D6").ToString, "|")(0)) %>'
                                                                ToolTip="Editar Mantenimiento"
                                                                CommandName="VerMantenimientoPlanificacionEquipo"
                                                    ...
                                                    <asp:TemplateField Visible="false"
                                                        HeaderStyle-CssClass="bg-200 text-900 p-1 m-0 small">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkbtnD7" runat="server"
                                                                Text='<%# IIf(IsNothing(Eval("D7")), "", Split(Eval("D7").ToString, "|")(0)) %>'
                                                                ToolTip="Editar Mantenimiento"
                                                                CommandName="VerMantenimientoPlanificacionEquipo"
                                                    ...
                                                    <asp:TemplateField Visible="false"
                                                        HeaderStyle-CssClass="bg-200 text-900 p-1 m-0 small">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkbtnD8" runat="server"
                                                                Text='<%# IIf(IsNothing(Eval("D8")), "", Split(Eval("D8").ToString, "|")(0)) %>'
                                                                ToolTip="Editar Mantenimiento"
                                                                CommandName="VerMantenimientoPlanificacionEquipo"
                                                    ...
                                                    <asp:TemplateField Visible="false"
                                                        HeaderStyle-CssClass="bg-200 text-900 p-1 m-0 small">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkbtnD9" runat="server"
                                                                Text='<%# IIf(IsNothing(Eval("D9")), "", Split(Eval("D9").ToString, "|")(0)) %>'
                                                                ToolTip="Editar Mantenimiento"
                                                                CommandName="VerMantenimientoPlanificacionEquipo"
                                                    ...
                                                    <asp:TemplateField Visible="false"
                                                        HeaderStyle-CssClass="bg-200 text-900 p-1 m-0 small">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkbtnD10" runat="server"
                                                                Text='<%# IIf(IsNothing(Eval("D10")), "", Split(Eval("D10").ToString, "|")(0)) %>'
                                                                ToolTip="Editar Mantenimiento"
                                                                CommandName="VerMantenimientoPlanificacionEquipo"
                                                    ...
                                                    <asp:TemplateField Visible="false"
                                                        HeaderStyle-CssClass="bg-200 text-900 p-1 m-0 small">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkbtnD11" runat="server"
                                                                Text='<%# IIf(IsNothing(Eval("D11")), "", Split(Eval("D11").ToString, "|")(0)) %>'
                                                                ToolTip="Editar Mantenimiento"
                                                                CommandName="VerMantenimientoPlanificacionEquipo"
                                                    ...
                                                    <asp:TemplateField Visible="false"
                                                        HeaderStyle-CssClass="bg-200 text-900 p-1 m-0 small">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkbtnD12" runat="server"
                                                                Text='<%# IIf(IsNothing(Eval("D12")), "", Split(Eval("D12").ToString, "|")(0)) %>'
                                                                ToolTip="Editar Mantenimiento"
                                                                CommandName="VerMantenimientoPlanificacionEquipo"
                                                    ...
                                                    <asp:TemplateField Visible="false"
                                                        HeaderStyle-CssClass="bg-200 text-900 p-1 m-0 small">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkbtnD13" runat="server"
                                                                Text='<%# IIf(IsNothing(Eval("D13")), "", Split(Eval("D13").ToString, "|")(0)) %>'
                                                                ToolTip="Editar Mantenimiento"
                                                                CommandName="VerMantenimientoPlanificacionEquipo"
                                                    ...
                                                    <asp:TemplateField Visible="false"
                                                        HeaderStyle-CssClass="bg-200 text-900 p-1 m-0 small">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkbtnD14" runat="server"
                                                                Text='<%# IIf(IsNothing(Eval("D14")), "", Split(Eval("D14").ToString, "|")(0)) %>'
                                                                ToolTip="Editar Mantenimiento"
                                                                CommandName="VerMantenimientoPlanificacionEquipo"
                                                    ...
                                                    <asp:TemplateField Visible="false"
                                                        HeaderStyle-CssClass="bg-200 text-900 p-1 m-0 small">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkbtnD15" runat="server"
                                                                Text='<%# IIf(IsNothing(Eval("D15")), "", Split(Eval("D15").ToString, "|")(0)) %>'
                                                                ToolTip="Editar Mantenimiento"
                                                                CommandName="VerMantenimientoPlanificacionEquipo"
                                                    ...
                                                    <asp:TemplateField Visible="false"
                                                        HeaderStyle-CssClass="bg-200 text-900 p-1 m-0 small">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkbtnD16" runat="server"
                                                                Text='<%# IIf(IsNothing(Eval("D16")), "", Split(Eval("D16").ToString, "|")(0)) %>'
                                                                ToolTip="Editar Mantenimiento"
                                                                CommandName="VerMantenimientoPlanificacionEquipo"
                                                    ...
                                                    <asp:TemplateField Visible="false"
                                                        HeaderStyle-CssClass="bg-200 text-900 p-1 m-0 small">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkbtnD17" runat="server"
                                                                Text='<%# IIf(IsNothing(Eval("D17")), "", Split(Eval("D17").ToString, "|")(0)) %>'
                                                                ToolTip="Editar Mantenimiento"
                                                                CommandName="VerMantenimientoPlanificacionEquipo"
                                                    ...
                                                    <asp:TemplateField Visible="false"
                                                        HeaderStyle-CssClass="bg-200 text-900 p-1 m-0 small">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkbtnD18" runat="server"
                                                                Text='<%# IIf(IsNothing(Eval("D18")), "", Split(Eval("D18").ToString, "|")(0)) %>'
                                                                ToolTip="Editar Mantenimiento"
                                                                CommandName="VerMantenimientoPlanificacionEquipo"
                                                    ...
                                                    <asp:TemplateField Visible="false"
                                                        HeaderStyle-CssClass="bg-200 text-900 p-1 m-0 small">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkbtnD19" runat="server"
                                                                Text='<%# IIf(IsNothing(Eval("D19")), "", Split(Eval("D19").ToString, "|")(0)) %>'
                                                                ToolTip="Editar Mantenimiento"
                                                                CommandName="VerMantenimientoPlanificacionEquipo"
                                                    ...
                                                    <asp:TemplateField Visible="false"
                                                        HeaderStyle-CssClass="bg-200 text-900 p-1 m-0 small">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkbtnD20" runat="server"
                                                                Text='<%# IIf(IsNothing(Eval("D20")), "", Split(Eval("D20").ToString, "|")(0)) %>'
                                                                ToolTip="Editar Mantenimiento"
                                                                CommandName="VerMantenimientoPlanificacionEquipo"
                                                    ...
                                                    <asp:TemplateField Visible="false"
                                                        HeaderStyle-CssClass="bg-200 text-900 p-1 m-0 small">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkbtnD21" runat="server"
                                                                Text='<%# IIf(IsNothing(Eval("D21")), "", Split(Eval("D21").ToString, "|")(0)) %>'
                                                                ToolTip="Editar Mantenimiento"
                                                                CommandName="VerMantenimientoPlanificacionEquipo"
                                                    ...
                                                    <asp:TemplateField Visible="false"
                                                        HeaderStyle-CssClass="bg-200 text-900 p-1 m-0 small">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkbtnD22" runat="server"
                                                                Text='<%# IIf(IsNothing(Eval("D22")), "", Split(Eval("D22").ToString, "|")(0)) %>'
                                                                ToolTip="Editar Mantenimiento"
                                                                CommandName="VerMantenimientoPlanificacionEquipo"
                                                    ...
                                                    <asp:TemplateField Visible="false" 
                                                        HeaderStyle-CssClass="bg-200 text-900 p-1 m-0 small">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkbtnD23" runat="server"
                                                                Text='<%# IIf(IsNothing(Eval("D23")), "", Split(Eval("D23").ToString, "|")(0)) %>'
                                                                ToolTip="Editar Mantenimiento"
                                                                CommandName="VerMantenimientoPlanificacionEquipo"
                                                    ...
                                                    <asp:TemplateField Visible="false"
                                                        HeaderStyle-CssClass="bg-200 text-900 p-1 m-0 small">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkbtnD24" runat="server"
                                                                Text='<%# IIf(IsNothing(Eval("D24")), "", Split(Eval("D24").ToString, "|")(0)) %>'
                                                                ToolTip="Editar Mantenimiento"
                                                                CommandName="VerMantenimientoPlanificacionEquipo"
                                                    ...
                                                    <asp:TemplateField Visible="false"
                                                        HeaderStyle-CssClass="bg-200 text-900 p-1 m-0 small">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkbtnD25" runat="server"
                                                                Text='<%# IIf(IsNothing(Eval("D25")), "", Split(Eval("D25").ToString, "|")(0)) %>'
                                                                ToolTip="Editar Mantenimiento"
                                                                CommandName="VerMantenimientoPlanificacionEquipo"
                                                    ...
                                                    <asp:TemplateField Visible="false"
                                                        HeaderStyle-CssClass="bg-200 text-900 p-1 m-0 small">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkbtnD26" runat="server"
                                                                Text='<%# IIf(IsNothing(Eval("D26")), "", Split(Eval("D26").ToString, "|")(0)) %>'
                                                                ToolTip="Editar Mantenimiento"
                                                                CommandName="VerMantenimientoPlanificacionEquipo"
                                                    ...
                                                    <asp:TemplateField Visible="false"
                                                        HeaderStyle-CssClass="bg-200 text-900 p-1 m-0 small">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkbtnD27" runat="server"
                                                                Text='<%# IIf(IsNothing(Eval("D27")), "", Split(Eval("D27").ToString, "|")(0)) %>'
                                                                ToolTip="Editar Mantenimiento"
                                                                CommandName="VerMantenimientoPlanificacionEquipo"
                                                    ...
                                                    <asp:TemplateField Visible="false"
                                                        HeaderStyle-CssClass="bg-200 text-900 p-1 m-0 small">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkbtnD28" runat="server"
                                                                Text='<%# IIf(IsNothing(Eval("D28")), "", Split(Eval("D28").ToString, "|")(0)) %>'
                                                                ToolTip="Editar Mantenimiento"
                                                                CommandName="VerMantenimientoPlanificacionEquipo"
                                                    ...
                                                    <asp:TemplateField Visible="false"
                                                        HeaderStyle-CssClass="bg-200 text-900 p-1 m-0 small">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkbtnD29" runat="server"
                                                                Text='<%# IIf(IsNothing(Eval("D29")), "", Split(Eval("D29").ToString, "|")(0)) %>'
                                                                ToolTip="Editar Mantenimiento"
                                                                CommandName="VerMantenimientoPlanificacionEquipo"
                                                    ...
                                                    <asp:TemplateField Visible="false"
                                                        HeaderStyle-CssClass="bg-200 text-900 p-1 m-0 small">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkbtnD30" runat="server"
                                                                Text='<%# IIf(IsNothing(Eval("D30")), "", Split(Eval("D30").ToString, "|")(0)) %>'
                                                                ToolTip="Editar Mantenimiento"
                                                                CommandName="VerMantenimientoPlanificacionEquipo"
                                                    ...
                                                    <asp:TemplateField Visible="false"
                                                        HeaderStyle-CssClass="bg-200 text-900 p-1 m-0 small">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkbtnD31" runat="server"
                                                                Text='<%# IIf(IsNothing(Eval("D31")), "", Split(Eval("D31").ToString, "|")(0)) %>'
                                                                ToolTip="Editar Mantenimiento"
                                                                CommandName="VerMantenimientoPlanificacionEquipo"
