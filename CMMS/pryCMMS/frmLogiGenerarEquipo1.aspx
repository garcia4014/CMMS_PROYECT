<%@ Page Title="" Language="vb" AutoEventWireup="false" EnableEventValidation="false" MasterPageFile="~/PM_Cmms.Master" CodeBehind="frmLogiGenerarEquipo1.aspx.vb" Inherits="pryCMMS.frmLogiGenerarEquipo1" %>
...
<%--    <link href="vendors/flatpickr/flatpickr.min.css" rel="stylesheet">
    ...
    <link href="assets/css/theme.min.css" rel="stylesheet" id="style-default"><%--este guarda la grilla--%>
    ...
    <asp:UpdatePanel ID ="updpnlContent" runat="server">
        <ContentTemplate>
              ...
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <div class="row mt-1">
                    <div class="col-lg-6 col-sm-12">
                      ...
                      <div class="row">--%>
                                                    ...
                                                    <div class="modal-dialog-scrollable">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
									                            ...
									                            <div class="row">
										                            <div class="col-lg-3 col-md-4 mt-2">
											                            <span class="fas fa-stopwatch"></span><label class="text-black-50 col-form-label fs--2 m-1">Vida Útil:</label>
											                            <div class="input-group">
                                                            ...
                                                            <div class="modal-footer">
                                                                <div class="container overflow-scroll scrollbar">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-4 col-md-4 mt-2">
                                                                            <div id="divIdReferenciaSAPCaracteristica" runat="server"><span class="fas fa-phone-alt"></span><label class="text-black-50 col-form-label fs--2 m-1">Id. Referencia SAP:</label></div>
                                                                            <div class="input-group">
                                                                        ...
                                                                        <div class="col-lg-4 col-md-4 mt-2">
                                                                            <div id="divDescripcionCampoSAPCaracteristica" runat="server"><span class="fas fa-phone-alt"></span><label class="text-black-50 col-form-label fs--2 m-1">Descripción Campo SAP:</label></div>
                                                                            <div class="input-group">
                        ...
                        <div class="col-lg-4 col-md-12 mt-2">
                            <div class="mt-1"><asp:Label ID="lblTieneContrato" runat="server" CssClass="text-black-50 col-form-label col-form-label-sm fs--2 fw-semi-bold" Text="¿Tiene Contrato?:"></asp:Label></div>
                            <div class="input-group">
                                <div class="bootstrap-switch bootstrap-switch-on bootstrap bootstrap-switch-animate bootstrap-switch-mini ">
                                    <div class="bootstrap-switch-container">
                        ...
                        <div id="divContratoReferencia" runat="server" class="col-lg-8 col-md-6 mt-2">
                            <span class="far fa-clone"></span><label class="text-black-50 col-form-label col-form-label-sm fs--2 m-1">Contrato de Referencia:</label>
                            <div class="input-group">
                    ...
                    <div class="col-lg-6 col-sm-12 bg-200">
                        ...
                        <div class="row justify-content-between mt-3"> 
                            <div class="col-md-12 col-lg-12 col-xl-12 mb-4 mb-lg-0">
                                <div id="divGridDetalleCaracteristicaEquipo" style="overflow:auto; height:160px; align:left;" class="scrollbar">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 mt-2">
                        <span class="fas fa-shipping-fast"></span><label class="text-black-50 col-form-label fs--2 m-1">Ubicación:</label>
                        <div class="input-group">
                                ...
                                <div class="modal-dialog modal-xl">
                                    <div class="shadow rounded">
                                        <div class="modal-dialog-scrollable">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="myModalLabelCatalogoComponente">
                                                        Mantenimiento del Componente / Catalogo</h4>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row mt-1">
                                                            <div class="col-lg-6 col-sm-12">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-3 col-md-4 mt-2">
                                                                        <span class="far fa-address-card"></span><label class="text-black-50 col-form-label fs--2 m-1">Id.Compte.:</label>
                                                                        <div class="input-group">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-12 col-md-8 col-sm-8 mt-2">
                                                                        <span class="fas fa-chalkboard-teacher"></span><label class="text-black-50 col-form-label fs--2 m-1">Desc.Abreviada:</label>
                                                                        <div class="input-group">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-3 col-md-4 col-sm-4 mt-2">
                                                                        <span class="fas fa-chalkboard-teacher"></span><label class="text-black-50 col-form-label fs--2 m-1">P.Garantía:</label>
                                                                        <div class="input-group">
                                                                        ...
                                                                        <div class="col-lg-3 col-md-4 col-sm-4 mt-2">
                                                                        <span class="fas fa-chalkboard-teacher"></span><label class="text-black-50 col-form-label fs--2 m-1">P.Mant.:</label>
                                                                        <div class="input-group">
                                ...
                                <div class="modal-dialog modal-xl">
                                    <div class="shadow rounded">
                                        <div class="modal-dialog-scrollable">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="myModalLabelEquipoComponente">
                                                        Mantenimiento del Componente / Equipo</h4>
                                                                ...
                                                                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                                                    <div class="dropdown font-sans-serif btn-reveal-trigger">
                                                                      ...
                                                                      <div class="dropdown-menu dropdown-menu-end py-0" aria-labelledby="OpcionesComponentesCatalogo">
                                                                          ...
                                                                          <asp:LinkButton ID="lnkbtnAgregarCatalogoComponente" runat="server" ToolTip="Agregar componente al equipo" Text="<span class='fas fa-file-signature me-2'></span>Agregar al Equipos" CssClass="nav-link nav-link-card-details" />
														...
														<div id="divGridCatalogoComponente" style="overflow:auto; height:220px; align:left;" class="scrollbar">
															<asp:GridView ID="grdCatalogoComponente" runat="server" AutoGenerateColumns="False" TabIndex="20"
																...
																<Columns>
                                                                    <asp:TemplateField>
                                                                        <ItemTemplate>
                                                                            <asp:CheckBox ID="chkRowCatalogoComponente" runat="server" />
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
												...
												<div class="card mb-3">
													<div class="card-header">
														<div class="row">
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    <div class="form-group row pt-2">
                                                                                        <span class="col-sm-12 col-form-label-sm text-center text-900">¿Seguro desea eliminar este componente asignado?</span>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="modal-footer">
															...
															<%--<div class="col-1">
																<asp:ImageButton ID="imgbtnEliminarDetalleEquipo" runat="server" Height="25px" 
																						ImageUrl="~/Imagenes/Remover.jpg" ToolTip="Eliminar Registro" Width="25px" />
															</div>
															<div class="col-1">
																<asp:ImageButton ID="imgbtnEditarDetalleEquipo" runat="server" Height="25px" onfocus="fnSetFocus('ctl00$cuerpo$txtIdInternoDetalleMaestroActivo')"
														...
														<div id="divGridComponenteEquipo" style="overflow:auto; height:220px; align:left;" class="scrollbar">
															<asp:GridView ID="grdEquipoComponente" runat="server" AutoGenerateColumns="False" TabIndex="21"
																...
																<Columns>
																	...
																	<asp:BoundField DataField="IdSistemaFuncional" HeaderText="Sistema Funcional" />
																	<asp:BoundField DataField="DescripcionAbreviada" HeaderText="Descripción Abreviada" />
																	<%--BoundField DataField="IdCuentaContable" HeaderText="Cuenta Contable Asignada" />
            ...
            <ajaxToolkit:ModalPopupExtender ID="lnk_mostrarPanelMensajeClienteUbicacion_ModalPopupExtender" 
                runat="server" BackgroundCssClass="FondoAplicacion" 
                CancelControlID="imgbtnCancelarMensajeClienteUbicacionImagen" DropShadow="False" 
                ...
                <div class="modal-dialog modal-sm">
                    <div class="shadow rounded">
                        <div class= "modal-dialog-scrollable">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title" id="myModalLabelMensajeClienteUbicacion">
                                        Mensaje Informativo</h4>
                                    <asp:Button ID="imgbtnCancelarMensajeClienteUbicacionImagen" runat="server" CssClass="btn-close btn btn-sm btn-circle d-flex flex-center transition-base" data-dismiss="modal" aria-label="Close" />
                                </div>
                                <div class="modal-body">
                                    <div class="form-group pt-2">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 text-center">
                                                <h1><asp:Label ID="lblRazonSocialClienteMensajeClienteUbicacion" runat="server" Text="00000" CssClass="col-form-label-sm h4" ></asp:Label></h1>
                                            </div>
                                            <div class="col-sm-12 text-center">
                                        ...
                                        <div class="row pt-1">
                                            ...
                                            <%--<div class="col-sm-12">
                                                <asp:Label ID="lblCorreoAdicionalMensajeClienteUbicacion" runat="server" Text="Correo:" CssClass="text-black-50 col-form-label col-form-label-sm" ></asp:Label>
                                                <asp:TextBox ID="txtCorreoAdicionalMensajeClienteUbicacion" runat="server" CssClass="form-control form-control-sm" autocomplete="off" style="text-transform :uppercase;" TabIndex="105" TextMode="Email"></asp:TextBox>
                                            </div>
                                            <div class="col-md-4">
                                                <asp:Label ID="lblTelefonoAdicionalMensajeClienteUbicacion" runat="server" Text="Teléfono:" CssClass="text-black-50 col-form-label col-form-label-sm" ></asp:Label>
                                                <asp:TextBox ID="txtTelefonoAdicionalMensajeClienteUbicacion" runat="server" CssClass="form-control form-control-sm" autocomplete="off" style="text-transform :uppercase;" TabIndex="106" TextMode="Phone"></asp:TextBox>
                                            </div>
                                            <div class="col-md-4">
                                                <asp:Label ID="lblCelularAdicionalMensajeClienteUbicacion" runat="server" Text="Celular:" CssClass="text-black-50 col-form-label col-form-label-sm" ></asp:Label>
                                                <asp:TextBox ID="txtCelularAdicionalMensajeClienteUbicacion" runat="server" CssClass="form-control form-control-sm" autocomplete="off" style="text-transform :uppercase;" TabIndex="107" TextMode="Phone"></asp:TextBox>
                                            </div>
                                            <div class="col-md-4">
                                                <asp:Label ID="lblFaxAdicionalMensajeClienteUbicacion" runat="server" Text="Fax:" CssClass="text-black-50 col-form-label col-form-label-sm" ></asp:Label>
                                                <asp:TextBox ID="txtFaxAdicionalMensajeClienteUbicacion" runat="server" CssClass="form-control form-control-sm" autocomplete="off" style="text-transform :uppercase;" TabIndex="108" TextMode="Phone"></asp:TextBox>
                                            </div>--%>
                                            <div class="col-md-12">
                                ...
                                <div class="modal-footer">
                                    <asp:Button ID="btnAceptarMensajeClienteUbicacion" runat="server" Text="Aceptar" CssClass="btn btn-outline-facebook btn-sm d-block w-100" ToolTip="Aceptar Información" ValidationGroup="vgrpValidarClienteUbicacion" />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                          <div class="card h-100">
                            ...
                            <div class="card-body overflow-hidden">
                              <p>Galeria de imagenes del equipo principal.</p>
                              <div class="row mx-n1">
                                     ...
                                     <asp:DataList ID="lstGaleriaEquipo" runat="server" DataKeyField="Codigo" 
                                        ...
                                        BorderWidth="1px" GridLines="Both" CellPadding="3"
...
<a href='<%# "FullImage.ashx?ImID=" + "Imagenes/Equipo/" & Eval("Codigo") & "-" & Eval("NumeroItem") & ".jpg" %>' rel="lightbox">
                                    <asp:Image ID="Image1" runat="server" ImageUrl='<%# "ThumbNailImage.ashx?ImID=" + "Imagenes/Equipo/" & Eval("Codigo") & "-" & Eval("NumeroItem") & ".jpg"  %>'
                                ...
                                <div class="col-4 p-1"><a href="assets/img/gallery/5.jpg" data-gallery="gallery-1"><img class="img-fluid rounded" src="assets/img/gallery/5.jpg" alt="" /></a></div>
                                <div class="col-4 p-1"><a href="assets/img/gallery/333.jpg" data-gallery="gallery-1"><img class="img-fluid rounded" src="assets/img/gallery/3.jpg" alt="" /></a></div>
                              </div>
                            </div>
                          </div>
                        </div>
    ...
    <%-- <asp:UpdatePanel ID="updpnlSeleccionarSubirImagenEquipo" runat="server">
    <ContentTemplate>--%>
        ...
        <div class="modal-dialog modal-lg">
            <div class="shadow rounded">
                <div class="modal-dialog-scrollable">
                    <div class="modal-content">
                        <div class="modal-header bg-light">
                            <h4 class="modal-title" id="myModalLabelSubirImagenEquipo">
                        ...
                        <div class="modal-footer">
                            <%--<asp:Label ID="lblMensajeSubirImagenEquipo" runat="server" CssClass="col-form-label col-form-label-sm text-danger"></asp:Label>--%>
