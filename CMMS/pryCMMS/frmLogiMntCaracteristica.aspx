<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/PM_Cmms.Master" CodeBehind="frmLogiMntCaracteristica.aspx.vb" Inherits="pryCMMS.frmLogiMntCaracteristica" %>
        ...
        <div class="panel panel-default">
            <div id="dvTab">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item"><a class="nav-link active" href="#tab1" aria-controls="tab1" role="tab" data-toggle="tab">Listado de Caracteristicas</a></li>
                        ...
                        <asp:UpdatePanel ID="updpnlTab1" runat="server">
                            <ContentTemplate>
                                ...
                                <asp:Panel ID="pnlListado" runat="server" CssClass="container"
                                    DefaultButton="imgbtnBuscarCaracteristica">
                                    <div class="row pt-2">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="input-group">
                                                ...
                                                &nbsp;
                                                <asp:ImageButton ID="imgbtnBuscarCaracteristica" runat="server" Height="18px" TabIndex="3" CssClass="mt-1"
                        ...
                        <asp:UpdatePanel ID="updpnlTab2" runat="server">
                            ...
                            <asp:Panel ID="pnlGeneral" runat="server" CssClass="container">
                                <div class="col-12 mt-2">
                                    <h3 class="h5">Mantenimiento de Caracteristicas</h3>
                                </div>
                                <div class="mt-2">
                                    <div class="row">
                                        <label class="col-md-3 text-black-50 col-form-label col-form-label-sm pt-md-2 pt-sm-1">IdCaracteristica:</label>
                                        <div class="col-md-2 col-sm-4 pt-md-2 pt-sm-1">
                                            <div class="input-group">
                                                <asp:TextBox ID="txtIdCaracteristica" runat="server" CssClass="form-control form-control-sm" TabIndex="10"
                                        ...
                                        <div class="col-md-9 pt-md-2 pt-sm-1">
                                            <div class="input-group">
                                                <asp:TextBox ID="txtDescripcion" runat="server" CssClass="form-control form-control-sm" TabIndex="12"
                                                    style="text-transform :uppercase" placeholder="Descripción de la Caracteristica" ></asp:TextBox>
                                        ...
                                        <div class="col-md-9 pt-md-2 pt-sm-1">
                                            <div class="input-group">
                                                <asp:TextBox ID="txtDescripcionAbreviada" runat="server" CssClass="form-control form-control-sm" TabIndex="13"
                                                            style="text-transform :uppercase" placeholder="Descripción Abreviada del la Caracteristica" ></asp:TextBox>
