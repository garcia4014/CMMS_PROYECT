<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/PM_Cmms.Master" CodeBehind="frmGnrlMntLocal.aspx.vb" Inherits="pryCMMS.frmGnrlMntLocal" %>
        ...
        <div class="panel panel-default">
            <div id="dvTab">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item"><a class="nav-link active" href="#tab1" aria-controls="tab1" role="tab" data-toggle="tab">Listado de Locales</a></li>
                        ...
                        <asp:UpdatePanel ID="updpnlTab1" runat="server">
                            <ContentTemplate>
                                ...
                                <asp:Panel ID="pnlListado" runat="server" CssClass="container"
                                    DefaultButton="imgbtnBuscarLocal">
                                    <div class="row pt-2">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="input-group">
                                                ...
                                                &nbsp;
                                                <asp:ImageButton ID="imgbtnBuscarLocal" runat="server" Height="18px" TabIndex="3" CssClass="mt-1"
                        ...
                        <asp:UpdatePanel ID="updpnlTab2" runat="server">
                            ...
                            <asp:Panel ID="pnlGeneral" runat="server" CssClass="container">
                                <div class="col-12 mt-2">
                                    <h3 class="h5">Mantenimiento de Locales</h3>
                                </div>
                                <div class="mt-2">
                                    <div class="row">
                                        <label class="col-md-3 text-black-50 col-form-label col-form-label-sm pt-md-2 pt-sm-1">IdLocal:</label>
                                        <div class="col-md-2 col-sm-4 pt-md-2 pt-sm-1">
                                            <div class="input-group">
                                                <asp:TextBox ID="txtIdLocal" runat="server" CssClass="form-control form-control-sm" TabIndex="10"
                                                    style="text-transform :uppercase" Enabled="False"></asp:TextBox>
                                            </div>
                                        </div>
                                        <label class="col-md-3 text-black-50 col-form-label col-form-label-sm pt-md-2 pt-sm-1">Empresa:</label>
                                        <div class="col-md-4 col-sm-4 pt-md-2 pt-sm-1">
                                            <div class="input-group">
                                                <asp:DropDownList ID="cboEmpresa" runat="server" AppendDataBoundItems="True" TabIndex="11"
                                                ...
                                                <ajaxToolkit:ListSearchExtender ID="cboEmpresa_ListSearchExtender" runat="server"
                                                    Enabled="True" PromptText="Iniciar Búsqueda" TargetControlID="cboEmpresa">
                                                </ajaxToolkit:ListSearchExtender>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row pt-1">
                                        <label class="col-md-3 text-black-50 col-form-label col-form-label-sm pt-md-2 pt-sm-1">Descripción:</label>
                                        <div class="col-md-9 pt-md-2 pt-sm-1">
                                            <div class="input-group">
                                                <asp:TextBox ID="txtDescripcion" runat="server" CssClass="form-control form-control-sm" TabIndex="12"
                                                    style="text-transform :uppercase" placeholder="Descripción del Local" ></asp:TextBox>
                                    ...
                                    <div class="row">
                                        <label class="col-md-3 text-black-50 col-form-label col-form-label-sm pt-md-2 pt-sm-1">Desc. Abreviada:</label>
                                        <div class="col-md-9 pt-md-2 pt-sm-1">
                                            <div class="input-group">
                                                <asp:TextBox ID="txtDescripcionAbreviada" runat="server" CssClass="form-control form-control-sm" TabIndex="13"
                                                            style="text-transform :uppercase" placeholder="Descripción Abreviada del Local" ></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="rfvDescripcionAbreviada" runat="server" 
                                                    ...
                                                    ErrorMessage="Ingrese la descripción abreviada" Font-Size="10px" ForeColor="Red"
                                                    ValidationGroup="vgrpValidar">(*)</asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <ContentTemplate>
                                        <div class="row pt-1">
                                            <label class="col-md-3 text-black-50 col-form-label col-form-label-sm pt-md-2 pt-sm-1">País:</label>
                                            ...
                                            <label class="col-md-3 text-black-50 col-form-label col-form-label-sm pt-md-2 pt-sm-1">Departamento:</label>
                                            <div class="col-md-3 pt-md-2 pt-sm-1">
                                                <div class="input-group">
                                        ...
                                        <div class="row">
                                            <label class="col-md-3 text-black-50 col-form-label col-form-label-sm pt-md-2 pt-sm-1">Provincia:</label>
                                            <div class="col-md-3 pt-md-2 pt-sm-1">
                                                <div class="input-group">
                                            ...
                                            <label class="col-md-3 text-black-50 col-form-label col-form-label-sm pt-md-2 pt-sm-1">Distrito:</label>
                                            <div class="col-md-3 pt-md-2 pt-sm-1">
                                                <div class="input-group">
                                    ...
                                    <div class="row">
                                        <label class="col-md-3 text-black-50 col-form-label col-form-label-sm pt-md-2 pt-sm-1">Dirección Local:</label>
                                        <div class="col-md-9 pt-md-2 pt-sm-1">
                                            <div class="input-group">
                                                <asp:TextBox ID="txtDireccionLocal" runat="server" CssClass="form-control form-control-sm" TabIndex="14"
                                                            style="text-transform :uppercase" placeholder="Descripción Abreviada del Local" ></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <label class="col-md-3 text-black-50 col-form-label col-form-label-sm pt-md-2 pt-sm-1">Aforo:</label>
                                        <div class="col-md-9 pt-md-2 pt-sm-1">
                                            <div class="input-group">
                                                <asp:TextBox ID="txtAforo" runat="server" CssClass="form-control form-control-sm" TabIndex="15"
                                                            style="text-transform :uppercase" placeholder="Descripción Abreviada del Local" TextMode="Number"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <label class="col-md-3 text-black-50 col-form-label col-form-label-sm pt-md-2 pt-sm-1">Local Sunat:</label>
                                        <div class="col-md-9 pt-md-2 pt-sm-1">
                                            <div class="input-group">
                                                <asp:TextBox ID="txtLocalSunat" runat="server" CssClass="form-control form-control-sm" TabIndex="16"
                                                            style="text-transform :uppercase" placeholder="Código del establecimiento según SUNAT" ></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                </div>
